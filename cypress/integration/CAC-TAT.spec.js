...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function(){
      ...
      cy.get('#email').type('email@algumacoisa.com.br')
    ...
    it('exibe mensagem de erro quando ao submeter o formulário com um e-mail com formatação inválida', function(){
      cy.get('#firstName').type('Renata')
      cy.get('#lastName').type('Rahal')
    ...
    it('seleciona um arquivo simulando um drag-and-drop - simula arrastar o arquivo para cima da página', function(){
      cy.get('input[type="file"]')
        .should('not.have.value')
